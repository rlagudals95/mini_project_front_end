...
const PostWrite = (props) => {
  ...
  // console.log("찾은 post", postIdx);
  // console.log("게시물 수정정보", post_list);
  // console.log("게시물 수정정보 아이디들", post_list[10]);
  // console.log("현재 포스트 id", post_id); //이거랑 같아야 하는데...
  React.useEffect(() => {
    if (is_edit && !_post) {
  ...
  const addPost = () => {
    ...
    dispatch(postActions.addPostAX(contents, token));
  };
